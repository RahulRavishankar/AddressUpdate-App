...
import com.example.AddressUpdateApp.otpapi.model.Opts;
import com.example.AddressUpdateApp.otpapi.model.Otp;
import com.example.AddressUpdateApp.otpapi.model.OtpRes;
import com.example.AddressUpdateApp.otpapi.model.Type;
import com.example.AddressUpdateApp.otpapi.util.NamespaceFilter;
...
public class OtpAPIService {
    ...
    public OtpRes getOtpRes(String uid, String txnId) throws Exception {
        Type type;
        if(uid.length()>12){
            type = Type.V;
        }else {
